...
//        SpinnerModel moveModel1 = new SpinnerNumberModel(0, -100, 100, 1);
        moveX.setModel(new SpinnerNumberModel(object3D.getXMove(), -400, 400, 0.1));
        moveY.setModel(new SpinnerNumberModel(object3D.getYMove(), -400, 400, 0.1));
        moveZ.setModel(new SpinnerNumberModel(object3D.getZMove(), -400, 400, 0.1));
